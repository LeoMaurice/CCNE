...
ui <- fluidPage(
  ...
  fluidRow(
    ...
    column(6, 
           actionButton("cite_memoire", "Site du mémoire", 
           ...
           actionButton("info_avis", "Informations diverses sur les avis du CCNE", 
                        onclick = "window.location.href='https://leomaurice.github.io/CCNE/description_avis.html'",
                        width = '100%'),
           actionButton("professions", "Description professions des membres du CCNE",
                        onclick = "window.location.href='https://leomaurice.github.io/CCNE/description_membres.html'",
                        width = '100%'),
           actionButton("personality", "Rapport à la personnalité humaine au sein des avis du CCNE",
                        onclick = "window.location.href='https://leomaurice.github.io/CCNE/personne_across_avis.html'",
                        width = '100%'),
           actionButton("summary_citations", "Résumé des citations",
                        onclick = "window.location.href='https://leomaurice.github.io/CCNE/reseau_citations.html'",
                        width = '100%')
    )
  ),
