...
AJOUTER UNE LEMMATIZATION ? pour éviter ce que j'ai déjà fait ?
...
tm_lda <- LDA(tm_data, k = 14, method = "Gibbs", 
...
## Faire tourner le modèle: première implémentation avec stm
