...
#| eval: true
#| output: true
#| tbl-cap: "Ensemble des 15 mots les plus fréquents par topic"
# tbl-cap-location: top
#| label: tbl-stm-full_prob_words
#| 
plot(stm_lda, type = "labels", labeltype = "prob", n=15)|> kable(digits = 3)
```
...
plot(stm_lda, type = "labels", labeltype = "frex", frexw=0.5, n = 15)|> kable(digits = 3)
```
