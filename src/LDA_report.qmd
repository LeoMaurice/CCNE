...
#| eval: true
#| output: true
#| fig-cap: Intertopic Distance Map (PCA, multidimensional scaling)
#| fig-subcap: Marker size is proportionnal to topic prevalence
...
tm_metadata|>
  ...
  ggpubr::ggscatter(x="Annee", y = "moyenne", facet.by = "ordre", panel.labs = list(ordre = paste("topic",ordre_ldavis)), xlab = "Année",ylab = "Mean Prevalence")+
  geom_line()+
  theme_prism()
```
