...
base_sentences|>
  ...
  stat_pvalue_manual(stat.test, label = "p.adj.signif", hide.ns = TRUE,y.position = 2000, step.increase = 0.04)

```

### Nombre de tableaux et graphiques par président
...
stat_annotation <- data.frame(
  tag = c("Agent responsable", "Humain comme empathie", "Genre/espèce humain.e", "Individu", 
          "Matériel biologique", "Personne à protéger", "Personne relationnelle", "Poubelle"),
  Freq = c(75, 9, 65, 68, 92, 115, 64, 12)
)|>
  mutate(FreqPerc = 100*Freq/n_annoté)

# Création du graphique
ggbarplot(stat_annotation, 
...
if(save_figures)
  ggsave(paste0("../output/descriptive_figures/frequence_annotation_",n_annoté,".png"))
