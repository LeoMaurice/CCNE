...
```{r}
#| eval: true
# Filtrer les résultats pour afficher uniquement les documents avec au moins un NA dans ids_rapporteurs
# metadata_avis %>%
#   filter(sapply(ids_rapporteurs, function(x) any(is.na(x)))) %>%
#   select(num, rapporteurs, ids_rapporteurs, membres_gt, ids_membres_gt)%>%
#   View()
