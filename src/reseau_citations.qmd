...
color_pal_groupe = c("#285291","#9D3A5E","#579125","#0F0F5C","#91188F","#0E405C", "#915B11" , "#4F2B91", "#91181E","#0B5C2D","#BD6345")
...
ggraph(hierar, layout = 'fr') + # layout 'fr' pour Fruchterman-Reingold, une mise en page de base
