...
knitr::kable(final_table,
             caption = "Tableau de l'auteur.\nDonnées de l'auteur.\nChamp : Ensembles des phrases sur la personnalité humaines dans les 144.\nLecture : Durant le mandat de Bernard, 85.7% des avis contiennent au moins une phrase sur le corps humain.\nOn peut conclure de l'augmentation de chaque catégorie, une diversification des rhétoriques.",
             title = "Pourcentage des avis utilisant au moins une fois certaine catégorie de phrases.")
...
# Display the final table
knitr::kable(final_table,
             caption = "Tableau de l'auteur.\nDonnées de l'auteur.\nChamp : Ensembles des phrases sur la personnalité humaines dans les 144.\nLecture : Durant le mandat de Bernard, 45.9% des phrases publiées portent sur le corps humain.",
             title = "Pourcentage des phrases publiés utilisant certaine catégorie de phrases.")
